...
interface ISearchInfoTileProps {
    key: any
    result: any
    width: any
    classes: any
...
interface ISearchInfoTileStates {
    expanded: boolean
    fullResult: any
}
...
// SearchInfoTile formats the information returned from the Jikan API into a short 
// summary card which the user can click to expand and view more details
class SearchInfoTile extends React.Component<ISearchInfoTileProps, ISearchInfoTileStates> {
    ...
    constructor(props: ISearchInfoTileProps) {
        super(props)
...
export default withStyles(styles)(withWidth()(SearchInfoTile))